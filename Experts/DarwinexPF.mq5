...
//| DP EA
//|
//|    Generated by StrategyQuant X Build 137 for MetaTrader5 (hedged)
//|    Generated at 12/06/2023 13:09
//| 
//|    Backtested on ?? / ??, ?? - ?? 
//+------------------------------------------------------------------+
...
input string CustomComment = "Port2";        //CustomComment
input string CustomComment2 = "Port1";        //CustomComment2
...
input string CustomComment3 = "Port3";        //CustomComment3
...
input string CustomComment4 = "Port4";        //CustomComment4
...
input string CustomComment5 = "Port5";        //CustomComment5
input int MagicNumber5 = 11115;        //MagicNumber5
bool LongEntrySignal5 = false;        //LongEntrySignal5
bool ShortEntrySignal5 = false;        //ShortEntrySignal5
bool LongExitSignal5 = false;        //LongExitSignal5
bool ShortExitSignal5 = false;        //ShortExitSignal5
input string CustomComment6 = "Port6";        //CustomComment6
input int MagicNumber6 = 11116;        //MagicNumber6
bool LongEntrySignal6 = false;        //LongEntrySignal6
bool ShortEntrySignal6 = false;        //ShortEntrySignal6
bool LongExitSignal6 = false;        //LongExitSignal6
bool ShortExitSignal6 = false;        //ShortExitSignal6
input string CustomComment7 = "Port7";        //CustomComment7
input int MagicNumber7 = 11117;        //MagicNumber7
bool LongEntrySignal7 = false;        //LongEntrySignal7
bool ShortEntrySignal7 = false;        //ShortEntrySignal7
bool LongExitSignal7 = false;        //LongExitSignal7
bool ShortExitSignal7 = false;        //ShortExitSignal7
...
input string Subchart1Symbol = "EURUSD";
input int Subchart1Timeframe = -2;
...
#define MOVINGAVERAGE_1 0     //iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 20, 0, MODE_SMA, PRICE_LOW)
#define ADX_1 1     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqADX", 30)
#define ADX_2 2     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqADX", 160)
#define ATR_1 3     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", 14)
#define ADX_3 4     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqADX", 14)
#define ATR_2 5     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", 40)
#define ATR_3 6     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", 20)
#define ATR_4 7     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", 50)
#define RSI_1 8     //iRSI(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 97, PRICE_LOW)
#define RSI_2 9     //iRSI(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 20, PRICE_CLOSE)
#define ADX_4 10     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqADX", 20)
#define RSI_3 11     //iRSI(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 40, PRICE_CLOSE)
#define ATR_5 12     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", 30)
#define MOVINGAVERAGE_2 13     //iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 30, 0, MODE_LWMA, PRICE_CLOSE)
#define MOVINGAVERAGE_3 14     //iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 152, 0, MODE_SMA, PRICE_WEIGHTED)
#define ATR_6 15     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", 164)
#define RSI_4 16     //iRSI(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 20, PRICE_LOW)
#define HEIKENASHI_1 17     //255
#define HEIKENASHI_2 18     //255
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqGetIndicatorValue(MOVINGAVERAGE_1, 2+1)<sqGetIndicatorValue(MOVINGAVERAGE_1, 2))
      &&   sqIsRising(ADX_1, 2, false, 1));

     ShortEntrySignal = sqIsRising(ADX_2, 2, false, 2);
...
//------------------------
...
)
   {
      ...
      sl = sqFixMarketPrice(sqGetSLLevel("Subchart1Symbol", ORDER_TYPE_BUY, openPrice, 1, 250.0), "Subchart1Symbol");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Subchart1Symbol", ORDER_TYPE_BUY, openPrice, 1, 1.0), "Subchart1Symbol");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLLevel("Subchart1Symbol", ORDER_TYPE_SELL, openPrice, 1, 140.0), "Subchart1Symbol");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Subchart1Symbol", ORDER_TYPE_SELL, openPrice, 1, 2.0), "Subchart1Symbol");
      size = mmLots * mmMultiplier;
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((LongExitSignal
      &&   (!(LongEntrySignal)))
      &&   sqMarketPositionIsLong(MagicNumber, "Subchart1Symbol", CustomComment))
)
   {
      // Action #1
        // Close all positions
      sqCloseAllPositions("Subchart1Symbol", MagicNumber, 1, CustomComment);
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((ShortExitSignal
      &&   (!(ShortEntrySignal)))
      &&   sqMarketPositionIsShort(MagicNumber, "Subchart1Symbol", CustomComment))
)
   {
      // Action #1
        // Close all positions
...
if (_sqIsBarOpen == true) {
     // init signals only on bar open 
     LongEntrySignal2 = ((sqIsFalling(ATR_1, 2, false, 3)
      &&   sqIsRising(ADX_3, 2, false, 3))
      &&   sqIsFalling(ATR_2, 2, false, 3));

     ShortEntrySignal2 = sqIsRising(ATR_2, 2, false, 1);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLLevel("Subchart1Symbol", ORDER_TYPE_BUY, openPrice, 1, 90.0), "Subchart1Symbol");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Subchart1Symbol", ORDER_TYPE_BUY, openPrice, 1, 2.0), "Subchart1Symbol");
      size = mmLots * mmMultiplier;
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Subchart1Symbol", ORDER_TYPE_SELL, openPrice, 1, 5.0), "Subchart1Symbol");
      pt = sqFixMarketPrice(sqGetPTLevel("Subchart1Symbol", ORDER_TYPE_SELL, openPrice, 1, 75.0), "Subchart1Symbol");
      size = mmLots * mmMultiplier;
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((LongExitSignal2
      &&   (!(LongEntrySignal2)))
      &&   sqMarketPositionIsLong(MagicNumber2, "Subchart1Symbol", CustomComment2))
)
   {
      // Action #1
        // Close all positions
      sqCloseAllPositions("Subchart1Symbol", MagicNumber2, 1, CustomComment2);
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((ShortExitSignal2
      &&   (!(ShortEntrySignal2)))
      &&   sqMarketPositionIsShort(MagicNumber2, "Subchart1Symbol", CustomComment2))
)
   {
      // Action #1
        // Close all positions
...
if (_sqIsBarOpen == true) {
     // init signals only on bar open 
     LongEntrySignal3 = ((sqIsFalling(ATR_1, 2, false, 2)
      &&   sqIsFalling(ATR_3, 2, false, 2))
      &&   sqIsFalling(ATR_2, 2, false, 1));

     ShortEntrySignal3 = sqIsRising(ATR_4, 2, false, 3);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLLevel("Subchart1Symbol", ORDER_TYPE_BUY, openPrice, 1, 75.0), "Subchart1Symbol");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Subchart1Symbol", ORDER_TYPE_BUY, openPrice, 1, 6.0), "Subchart1Symbol");
      size = mmLots * mmMultiplier;
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((LongExitSignal3
      &&   (!(LongEntrySignal3)))
      &&   sqMarketPositionIsLong(MagicNumber3, "Subchart1Symbol", CustomComment3))
)
   {
      // Action #1
        // Close all positions
      sqCloseAllPositions("Subchart1Symbol", MagicNumber3, 1, CustomComment3);
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((ShortExitSignal3
      &&   (!(ShortEntrySignal3)))
      &&   sqMarketPositionIsShort(MagicNumber3, "Subchart1Symbol", CustomComment3))
)
   {
      // Action #1
        // Close all positions
...
if (_sqIsBarOpen == true) {
     // init signals only on bar open 
     LongEntrySignal4 = ((sqGetIndicatorValue(ADX_1, 1) < 20.0
      &&   sqIsRising(RSI_1, 2, false, 2))
      &&   sqIsRising(RSI_2, 2, false, 3));

     ShortEntrySignal4 = sqGetIndicatorValue(ADX_4, 1) < 50.0;
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Subchart1Symbol", ORDER_TYPE_BUY, openPrice, 1, 2.0), "Subchart1Symbol");
      pt = sqFixMarketPrice(sqGetPTLevel("Subchart1Symbol", ORDER_TYPE_BUY, openPrice, 1, 1195.0), "Subchart1Symbol");
      size = mmLots * mmMultiplier;
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Subchart1Symbol", ORDER_TYPE_SELL, openPrice, 1, 2.0), "Subchart1Symbol");
      pt = sqFixMarketPrice(sqGetPTLevel("Subchart1Symbol", ORDER_TYPE_SELL, openPrice, 1, 90.0), "Subchart1Symbol");
      size = mmLots * mmMultiplier;
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((LongExitSignal4
      &&   (!(LongEntrySignal4)))
      &&   sqMarketPositionIsLong(MagicNumber4, "Subchart1Symbol", CustomComment4))
)
   {
      // Action #1
        // Close all positions
      sqCloseAllPositions("Subchart1Symbol", MagicNumber4, 1, CustomComment4);
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((ShortExitSignal4
      &&   (!(ShortEntrySignal4)))
      &&   sqMarketPositionIsShort(MagicNumber4, "Subchart1Symbol", CustomComment4))
)
   {
      // Action #1
        // Close all positions
...
//------------------------
// Rule: Trading signals5
//------------------------
if (_sqIsBarOpen == true) {
     // init signals only on bar open 
     LongEntrySignal5 = (sqIsRising(RSI_3, 2, false, 2)
      &&   sqIsRising(ATR_1, 2, false, 3));

     ShortEntrySignal5 = sqIsRising(ATR_5, 2, false, 3);

     LongExitSignal5 = false;

     ShortExitSignal5 = false;
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLLevel("Subchart1Symbol", ORDER_TYPE_BUY, openPrice, 1, 140.0), "Subchart1Symbol");
      pt = sqFixMarketPrice(sqGetPTLevel("Subchart1Symbol", ORDER_TYPE_BUY, openPrice, 1, 195.0), "Subchart1Symbol");
      size = mmLots * mmMultiplier;
      ...
      _ticket = openPosition(
         ...
         pt, // Profit Target   
         correctSlippage(sqMaxEntrySlippage, "Subchart1Symbol"), // Max deviation
         CustomComment5, // Comment
         MagicNumber5, // MagicNumber
         ExpirationTime, // Expiration time
         false, // Replace existing (only for pending orders)
         false  // Allow duplicate trades
      );
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Subchart1Symbol", ORDER_TYPE_SELL, openPrice, 1, 8.0), "Subchart1Symbol");
      pt = sqFixMarketPrice(sqGetPTLevel("Subchart1Symbol", ORDER_TYPE_SELL, openPrice, 1, 60.0), "Subchart1Symbol");
      size = mmLots * mmMultiplier;
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((LongExitSignal5
      &&   (!(LongEntrySignal5)))
      &&   sqMarketPositionIsLong(MagicNumber5, "Subchart1Symbol", CustomComment5))
)
   {
      // Action #1
        // Close all positions
      sqCloseAllPositions("Subchart1Symbol", MagicNumber5, 1, CustomComment5);
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((ShortExitSignal5
      &&   (!(ShortEntrySignal5)))
      &&   sqMarketPositionIsShort(MagicNumber5, "Subchart1Symbol", CustomComment5))
)
   {
      // Action #1
        // Close all positions
...
//------------------------
// Rule: Trading signals6
//------------------------
if (_sqIsBarOpen == true) {
     // init signals only on bar open 
     LongEntrySignal6 = sqIsFalling(ATR_1, 2, false, 3);

     ShortEntrySignal6 = sqIsFalling(MOVINGAVERAGE_2, 2, false, 2);

     LongExitSignal6 = false;

     ShortExitSignal6 = false;
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLLevel("Subchart1Symbol", ORDER_TYPE_BUY, openPrice, 1, 95.0), "Subchart1Symbol");
      pt = sqFixMarketPrice(sqGetPTLevel("Subchart1Symbol", ORDER_TYPE_BUY, openPrice, 1, 625.0), "Subchart1Symbol");
      size = mmLots * mmMultiplier;
      ...
      _ticket = openPosition(
         ...
         pt, // Profit Target   
         correctSlippage(sqMaxEntrySlippage, "Subchart1Symbol"), // Max deviation
         CustomComment6, // Comment
         MagicNumber6, // MagicNumber
         ExpirationTime, // Expiration time
         false, // Replace existing (only for pending orders)
         false  // Allow duplicate trades
      );
...
//------------------------
...
)
   {
      ...
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Subchart1Symbol", ORDER_TYPE_SELL, openPrice, 1, 5.0), "Subchart1Symbol");
      pt = sqFixMarketPrice(sqGetPTLevel("Subchart1Symbol", ORDER_TYPE_SELL, openPrice, 1, 85.0), "Subchart1Symbol");
      size = mmLots * mmMultiplier;
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((LongExitSignal6
      &&   (!(LongEntrySignal6)))
      &&   sqMarketPositionIsLong(MagicNumber6, "Subchart1Symbol", CustomComment6))
)
   {
      // Action #1
        // Close all positions
      sqCloseAllPositions("Subchart1Symbol", MagicNumber6, 1, CustomComment6);
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((ShortExitSignal6
      &&   (!(ShortEntrySignal6)))
      &&   sqMarketPositionIsShort(MagicNumber6, "Subchart1Symbol", CustomComment6))
)
   {
      // Action #1
        // Close all positions
...
//------------------------
// Rule: Trading signals7
//------------------------
if (_sqIsBarOpen == true) {
     // init signals only on bar open 
     LongEntrySignal7 = (((sqOpen(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 0) < sqGetIndicatorValue(MOVINGAVERAGE_3, 1))
      &&   sqIsFalling(RSI_2, 2, false, 3))
      &&   sqIsFalling(ATR_6, 2, false, 1));

     ShortEntrySignal7 = sqIsFalling(RSI_4, 2, false, 1);

     LongExitSignal7 = false;

     ShortExitSignal7 = false;
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Subchart1Symbol", ORDER_TYPE_BUY, openPrice, 1, 5.0), "Subchart1Symbol");
      pt = sqFixMarketPrice(sqGetPTLevel("Subchart1Symbol", ORDER_TYPE_BUY, openPrice, 1, 965.0), "Subchart1Symbol");
      size = mmLots * mmMultiplier;
      ...
      _ticket = openPosition(
         ...
         pt, // Profit Target   
         correctSlippage(sqMaxEntrySlippage, "Subchart1Symbol"), // Max deviation
         CustomComment7, // Comment
         MagicNumber7, // MagicNumber
         ExpirationTime, // Expiration time
         false, // Replace existing (only for pending orders)
         false  // Allow duplicate trades
      );
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLLevel("Subchart1Symbol", ORDER_TYPE_SELL, openPrice, 1, 180.0), "Subchart1Symbol");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Subchart1Symbol", ORDER_TYPE_SELL, openPrice, 1, 1.0), "Subchart1Symbol");
      size = mmLots * mmMultiplier;
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((LongExitSignal7
      &&   (!(LongEntrySignal7)))
      &&   sqMarketPositionIsLong(MagicNumber7, "Subchart1Symbol", CustomComment7))
)
   {
      // Action #1
        // Close all positions
      sqCloseAllPositions("Subchart1Symbol", MagicNumber7, 1, CustomComment7);
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((ShortExitSignal7
      &&   (!(ShortEntrySignal7)))
      &&   sqMarketPositionIsShort(MagicNumber7, "Subchart1Symbol", CustomComment7))
)
   {
      // Action #1
        // Close all positions
...
bool checkComments(){
   ...
   if(StringLen(CustomComment5) > 30){
      Alert("Strategy initialization error - Comment CustomComment5 is longer than 30 characters");
      return false;
   }
   if(StringLen(CustomComment6) > 30){
      Alert("Strategy initialization error - Comment CustomComment6 is longer than 30 characters");
      return false;
   }
   if(StringLen(CustomComment7) > 30){
      Alert("Strategy initialization error - Comment CustomComment7 is longer than 30 characters");
      return false;
   }
   return true;
}
...
bool checkMagicNumber(ulong magicNo){
    ...
    if(magicNo == MagicNumber5){
         return true;
    }
    if(magicNo == MagicNumber6){
         return true;
    }
    if(magicNo == MagicNumber7){
         return true;
    }
    return false;
}
...
bool initIndicators(){
   ...
   indicatorHandles[MOVINGAVERAGE_1] = iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 20, 0, MODE_SMA, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ADX_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqADX", 30);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ADX_2] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqADX", 160);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", 14);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ADX_3] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqADX", 14);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", 40);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_3] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", 20);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_4] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", 50);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[RSI_1] = iRSI(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 97, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[RSI_2] = iRSI(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 20, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ADX_4] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqADX", 20);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[RSI_3] = iRSI(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 40, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_5] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", 30);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MOVINGAVERAGE_2] = iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 30, 0, MODE_LWMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MOVINGAVERAGE_3] = iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 152, 0, MODE_SMA, PRICE_WEIGHTED);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_6] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", 164);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[RSI_4] = iRSI(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 20, PRICE_LOW);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("250.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 250.0));
   }
   if(idHash == sqStringHash("140.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 140.0));
   }
   if(idHash == sqStringHash("90.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 90.0));
   }
   if(idHash == sqStringHash("75.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 75.0));
   }
   if(idHash == sqStringHash("75.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 75.0));
   }
   ...
   if(idHash == sqStringHash("1195.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 1195.0));
   }
   if(idHash == sqStringHash("90.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 90.0));
   }
   if(idHash == sqStringHash("195.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 195.0));
   }
   if(idHash == sqStringHash("140.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 140.0));
   }
   if(idHash == sqStringHash("60.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 60.0));
   }
   if(idHash == sqStringHash("625.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 625.0));
   }
   if(idHash == sqStringHash("95.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 95.0));
   }
   if(idHash == sqStringHash("85.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 85.0));
   }
   if(idHash == sqStringHash("965.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 965.0));
   }
   if(idHash == sqStringHash("180.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 180.0));
   }
